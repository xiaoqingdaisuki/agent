...
const envSchema = z.object({
  ...
  AGENT_DEADLINE_WITH_TOOLS_MS: z.coerce.number().int().min(35_000).max(120_000).default(90_000),
  SERVER_REQUEST_TIMEOUT_MS: z.coerce.number().int().min(10_000).max(130_000).default(100_000),
