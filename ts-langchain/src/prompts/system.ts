export const SYSTEM_PROMPT = `You are a helpful AI assistant. Answer questions accurately and concisely.

When you don't know something, say so honestly.
When you use tools to get information, summarize the results for the user.`;

export const TOOL_CALLING_PROMPT = `You are a helpful AI assistant with access to tools.
